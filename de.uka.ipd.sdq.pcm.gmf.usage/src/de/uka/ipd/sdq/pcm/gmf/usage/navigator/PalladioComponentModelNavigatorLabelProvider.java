...
public class PalladioComponentModelNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider,
    ...
    public Image getImage(View view) {
        ...
        case DelayEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?Delay", PalladioComponentModelElementTypes.Delay_3017); //$NON-NLS-1$
        case VariableUsageEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/Parameter/5.2?VariableUsage", PalladioComponentModelElementTypes.VariableUsage_3012); //$NON-NLS-1$
        case StopEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?Stop", PalladioComponentModelElementTypes.Stop_3002); //$NON-NLS-1$
        case BranchTransitionEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?BranchTransition", PalladioComponentModelElementTypes.BranchTransition_3009); //$NON-NLS-1$
        case StartEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?Start", PalladioComponentModelElementTypes.Start_3001); //$NON-NLS-1$
        case OpenWorkloadEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?OpenWorkload", PalladioComponentModelElementTypes.OpenWorkload_3016); //$NON-NLS-1$
        case VariableCharacterisationEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/Parameter/5.2?VariableCharacterisation", PalladioComponentModelElementTypes.VariableCharacterisation_3013); //$NON-NLS-1$
        case ScenarioBehaviour2EditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?ScenarioBehaviour", PalladioComponentModelElementTypes.ScenarioBehaviour_3007); //$NON-NLS-1$
        case LoopEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?Loop", PalladioComponentModelElementTypes.Loop_3005); //$NON-NLS-1$
        case EntryLevelSystemCallEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?EntryLevelSystemCall", PalladioComponentModelElementTypes.EntryLevelSystemCall_3003); //$NON-NLS-1$
        case ScenarioBehaviour3EditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?ScenarioBehaviour", PalladioComponentModelElementTypes.ScenarioBehaviour_3010); //$NON-NLS-1$
        case AbstractUserActionSuccessorEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Link?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?AbstractUserAction?successor", PalladioComponentModelElementTypes.AbstractUserActionSuccessor_4002); //$NON-NLS-1$
        case UsageScenarioEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Diagram?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?UsageModel", PalladioComponentModelElementTypes.UsageModel_1000); //$NON-NLS-1$
        case BranchEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?Branch", PalladioComponentModelElementTypes.Branch_3008); //$NON-NLS-1$
        case ScenarioBehaviourEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?ScenarioBehaviour", PalladioComponentModelElementTypes.ScenarioBehaviour_3014); //$NON-NLS-1$
        case UsageScenario2EditPart.VISUAL_ID:
            return getImage(
                    "Navigator?TopLevelNode?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?UsageScenario", PalladioComponentModelElementTypes.UsageScenario_2004); //$NON-NLS-1$
        case ClosedWorkloadEditPart.VISUAL_ID:
            return getImage(
                    "Navigator?Node?http://palladiosimulator.org/PalladioComponentModel/UsageModel/5.2?ClosedWorkload", PalladioComponentModelElementTypes.ClosedWorkload_3015); //$NON-NLS-1$
        }
